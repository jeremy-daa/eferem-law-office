  ...
  return (
        ...
        <div className="relative flex flex-col md:flex-row gap-10 px-5 md:px-[50px] lg:px-[100px] pt-[200px] pb-[100px]">
          <div className="w-full md:max-w-[50%] flex flex-col items-center text-center">
            <Image className='rounded-full w-[350px] h-[350px] object-cover mb-10' src={lawyer.image_cropped ? lawyer.image_cropped : lawyer.image} width={500} height={500} alt={lawyer?.name} quality={100} />
            ...
            <div className="flex items-center gap-5">
                {lawyer.socials.map((social: any) => (
                    <Link key={social.id} href={social.link} target="_blank" className="text-white text-2xl">
                      {social.icon}
                    </Link>
                ))}
            </div>
