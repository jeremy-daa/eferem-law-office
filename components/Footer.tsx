    ...
    <div className={`${currentPage === "admin" ? "flex" : "flex"} flex-col items-center gap-[50px] bg-[#085AA3] px-8 sm:px-16 md:px-[120px] py-10`}>
      ...
      <div className="w-full flex flex-col md:flex-row flex-wrap justify-between gap-14 px-0 sm:px-20">
        <div className="flex flex-col max-w-[300px] text-white gap-5">
          ...
          <p className="text-lg">ELO was founded in 2015 by its Principal Attorney Eferem Hailemariam Bezabhe to provide a full-fledged and full-service law office in Ethiopia.</p>
        ...
        <div className="flex flex-col max-w-[300px] text-white gap-5">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href={"/practice-areas"} className="text-lg">Practice Areas</Link>
            <Link href={"/our-team"} className="text-lg">Our Team</Link>
        ...
        <div className="flex flex-col max-w-[300px] text-white gap-5">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-4"><CiPhone size={30} /><p className="text-lg">+251 93007 3321</p></div>
            {/* <div className="flex items-center gap-4"><CiPhone size={30} /><p className="text-lg">+251 91164 3741</p></div> */}
            <div className="flex items-center gap-4"><CiLocationOn size={30} /><p className="text-lg">P.0.B: 24016/1000</p></div>
            {/* <div className="flex items-center gap-4"><CiLocationOn size={30} /><p className="text-lg">Addis Ababa, Ethiopia</p></div> */}
            <div className="flex items-center gap-4"><CiMail size={30} /><p className="text-lg">eferemh@elo-law-ethiopia.com</p></div>
