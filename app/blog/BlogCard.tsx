...
export default function BlogCard({ d }: BlogCardProps) {
  ...
  return (
    <div className="w-full px-8 sm:px-[100px] pb-10 flex flex-col items-center gap-5">
      <h3 className="text-lg sm:text-xl md:text-xl text-[#3a3a38] font-normal text-center">
        News
      </h3>
      <h2 className="text-3xl sm:text-4xl md:text-6xl text-[#3a3a38] font-semibold text-center max-w-[600px] md:leading-[4.25rem] mb-10">
